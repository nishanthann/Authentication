...
const DashboardPage = () => {
  ...
  return (
    <motion.div
      ...
      className="max-w-md w-full mx-auto mt-10 p-8 bg-gray-900/50 bg-opacity-80 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl border border-gray-800"
    >
      <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-cyan-400 to-cyan-600 text-transparent bg-clip-text">
        Dashboard
      </h2>
